...
class SwissBERTModel(XMODModel):
    ...
    def _initialize_new_embeddings(self, pretrained_state_dict):
        ...
        old_vocab = XLMRobertaTokenizer.from_pretrained('xlm-roberta-base').get_vocab()
        ...
        # new_vocab =  (new_vocab_path).get_vocab()
        import os
        logging.info(f"Current dir {os.getcwd()}")
        new_vocab = XLMRobertaTokenizer.from_pretrained('../tokenizer').get_vocab()
