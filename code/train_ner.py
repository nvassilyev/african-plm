...
def main():
    ...
    parser.add_argument("--src_lang", type=str, help="Adapter purposes.")
    parser.add_argument("--freeze", action="store_true", help="Embedding and adapter layers frozen?")
...
###########################################################################################
    # freeze embeddings and adapter layers
    for parameter in model.parameters():
        parameter.requires_grad = True
    if args.freeze:
        model.freeze_embeddings_and_language_adapters()
    model.set_default_language(args.src_lang)
###########################################################################################
